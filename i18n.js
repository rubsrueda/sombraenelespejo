  ...
  es: {
    ...
    pages: {
      index: {
        ...
        tagline: "Todo reflejo oculta un pacto invisible. Todo silencio también.",
        lead: "Una historia que se adentra en la violencia psicológica desde lo íntimo, mostrando cómo lo cotidiano puede deformar la identidad hasta volverla irreconocible.",
      ...
      reviews: {
        ...
        realtimeBody: "Conectadas con Firebase Firestore.",
        star5: "5 estrellas",
        star4: "4 estrellas",
        star3: "3 estrellas",
        star2: "2 estrellas",
    ...
    dynamic: {
      buy: {
        ...
        checkoutHint: "<strong>Modo GitHub Pages (sin servidor):</strong> en Stripe configura la redirección tras pago exitoso a<br><span class=\"break-all\">{successUrl}</span><br><br>Alternativa por token:<br><span class=\"break-all\">{tokenUrl}</span><br><br><span class=\"text-slate-600\">El acceso queda guardado en este navegador. Para acceso multi-dispositivo necesitas backend.</span>",
      ...
      reviews: {
        ...
        firebaseConfig: "Configura Firebase en firebase-config.js para activar las reseñas en tiempo real.",
